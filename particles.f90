...
subroutine ie_vrt_nd(rhoa,vnext,tempr,tempt,v_output,rt_output, h)
   ...
   real :: mod_magnus,mod_ice
     ...
     rprime = (3.*(Si-1))/(916.8*rnext*(((((2.838e6)/(467.0*Tnext))-1)*((2.838e6)/(Kprime*Tnext)))+(467.0/(esi*Dprime))))
     ...
     Tprime = (((-3.0*Nup*Cpa*nuf*rhoa)/(2.*Pra*2108.0*916.8*(rnext**2)))*(Tnext-part%Tf)) + (3.0*2108.0*(1.0/(rnext*916.8))*rprime*(part%radius/taup0))
